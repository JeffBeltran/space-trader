...
import type { Shipyard, ShipyardShip } from "@/types/space-traders-api/ship";
...
export function ShipyardSlideOver({
    ...
    shipDetails: ShipyardShip;
}) {
    const [open, setOpen] = useState(false);

    const { data, post, processing } = useForm({
        shipType: shipDetails?.type,
        waypointSymbol: shipyardDetails.symbol,
    });
